...
// Lets admin fill in content metadata before publishing a story submission.
"use client";
...
export default function PublishDialog({
  ...
  const [form,       setForm]       = useState<PublishPayload>(EMPTY_FORM);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => {
                set("contentType", v);
                set("categoryId",  ""); // clear category when type changes
